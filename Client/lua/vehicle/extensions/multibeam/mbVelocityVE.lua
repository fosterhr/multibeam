-- Adapted for MultiBeam from BeamMP (https://github.com/BeamMP/BeamMP), velocityVE.lua.
...
local function onInit()
	...
	log('M', 'onInit', "mbVelocityVE init, physicsFPS: "..physicsFPS..", parentNode: "..tostring(parentNode))
end
