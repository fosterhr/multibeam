-- Adapted for MultiBeam from BeamMP (https://github.com/BeamMP/BeamMP), MPElectricsVE.lua.
...
local disallowedKeys = {
	...
	["accYSmooth"] = 1,
	["accZSmooth"] = 1,
	["engineRunning"] = 1, -- engine and ignition is synced in mbPowertrainVE
	["ignition"] = 1,
	["ignitionLevel"] = 1,
...
local function check()
	...
	if electricsChanged then
		obj:queueGameEngineLua("multibeam_client.sendElectrics(\'"..jsonEncode(electricsToSend).."\', "..obj:getID()..")")
	end
end
